...
document
    ...
    function optionSelected() {
        let optionId = this.value || this.options[this.selectedIndex].value;
        window.location.href =
            window.location.href.split("?")[0] + "?option_id=" + optionId;
    } 

// document.querySelector('.btn-search').addEventListener('submit', makeSearch);

// function makeSearch(){
   
//     let searchTerm = document.getElementById('search').value;
//     window.location.href = window.location.href.split("?")[0] + "?search=" + searchTerm;
// }
